import { BarChartCard, AreaChartCard, LineChartCard } from "../../_components/charts";
    ...
    <DemoShell>
      <div className="space-y-6">
        <div className="rounded-[32px] border border-slate-200 bg-white/90 p-6 shadow-sm">
          ...
          <h1 className="mt-3 text-3xl font-bold text-slate-950">หน้ารายงานที่ใช้ขายได้เลย</h1>
          <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-600">โชว์ลูกค้าได้ทันทีว่าระบบจะช่วยสรุปผลลัพธ์ แยกตามแพลตฟอร์ม และบอกแนวโน้มที่อ่านง่ายสำหรับการตัดสินใจ</p>
        </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[32px] border border-slate-200 bg-white/90 p-6 shadow-sm">
            ...
            <div className="mt-2 text-sm text-slate-500">ใช้คุยเรื่องงบ เวลา และช่องทางที่ควรโฟกัส</div>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white/90 p-6 shadow-sm">
            ...
            <div className="mt-2 text-sm text-slate-500">ตัวอย่าง insight ที่ช่วยชี้ว่าควรทำคอนเทนต์แบบไหนต่อ</div>
            <div className="mt-6 space-y-4">
